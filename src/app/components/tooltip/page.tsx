  ...
  return (
    <>
      <p style={{ marginBottom: '1.5rem' }}>
        <a href="https://tarmac-storybook-dev.pntrzz.com/storybook/sb/index.html?path=/story/tarmac-tds-tooltip--playground" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', fontWeight: 500, fontSize: '14px' }}>Open in Storybook \u2192</a>
      </p>
      <h2>Description</h2>
      <p>The Tooltip component is part of the TARMAC Design System. It provides a consistent, accessible, and reusable UI element for building interfaces across Delhivery products.</p>
      <h2>Availability</h2>
      <AvailabilityTable storybookUrl="https://tarmac-storybook-dev.pntrzz.com/storybook/sb/index.html?path=/story/tarmac-tds-tooltip--playground" />
    </>
  );
}
  ...
  return (
    <>
      ...
      <table><thead><tr><th>Component</th><th>Description</th></tr></thead><tbody>
        <tr><td>Trigger Element</td><td>The element that activates the tooltip on hover or focus</td></tr>
        <tr><td>Tooltip Container</td><td>Floating box containing the tooltip content</td></tr>
        <tr><td>Arrow</td><td>Small triangular pointer connecting tooltip to trigger</td></tr>
        <tr><td>Content Text</td><td>Descriptive text displayed inside the tooltip</td></tr>
      </tbody></table>
      <div style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-outline)', marginTop: '1.5rem', marginBottom: '0.5rem', background: '#fff' }}>
        <iframe src="https://tarmac-storybook-dev.pntrzz.com/storybook/sb/iframe.html?id=tarmac-tds-tooltip--playground&viewMode=story&shortcuts=false" style={{ width: '100%', height: '300px', border: 'none', display: 'block' }} title="tooltip example" loading="lazy" sandbox="allow-scripts allow-same-origin allow-popups allow-forms" />
      </div>

      <h2>Sizes</h2>
      <table><thead><tr><th>Size</th><th>Description</th></tr></thead><tbody>
        <tr><td>Default</td><td>Standard tooltip size that adapts to content length</td></tr>
      </tbody></table>

      <h2>States</h2>
      <table><thead><tr><th>State</th><th>Description</th></tr></thead><tbody>
        <tr><td>Hidden</td><td>Tooltip is not visible, trigger is in resting state</td></tr>
        <tr><td>Visible (top/bottom/left/right)</td><td>Tooltip shown in the specified position relative to trigger</td></tr>
        <tr><td>With Rich Content</td><td>Tooltip contains formatted text or interactive elements</td></tr>
      </tbody></table>
...
function GuidelinesTab() {
  return (
    <RoleToggle>
      ...
      <GuidelineImage title="When Not to Use \u2014 Tooltip" slug="tooltip" section="when-not-to-use" />
      <ul>
      ...
      <DoDont slug="tooltip" doItems={['Follow the design system guidelines', 'Use consistent sizing and spacing', 'Ensure proper accessibility attributes', 'Test across different viewports']} dontItems={["Don't modify the component outside its API", "Don't use inconsistent styling", "Don't ignore accessibility requirements", "Don't override design tokens without approval"]} />
        ...
        <>
          ...
          <h2>Import</h2>
          <pre style={{ background: 'var(--color-surface-dim)', padding: '16px', borderRadius: '8px', fontSize: '13px', overflow: 'auto' }}><code>{`import { Tooltip } from '@tarmac/design-system';`}</code></pre>
          ...
          <h2>Basic Usage</h2>
          <pre style={{ background: 'var(--color-surface-dim)', padding: '16px', borderRadius: '8px', fontSize: '13px', overflow: 'auto' }}><code>{`<Tooltip />`}</code></pre>
        </>
      )}
    </RoleToggle>
  );
...
export default function TooltipPage() {
  ...
  return (
    <PageShell title="Tooltip" description="Tooltip is a reusable component in the TARMAC Design System." tabs={tabs}>
      <OverviewTab />
    </PageShell>
  );
}
