  ...
  return (
    <>
      ...
      <div style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-outline)', marginBottom: '2rem', background: '#fff' }}>
        <iframe
          src={`https://tarmac-storybook.delhivery.com/storybook/sb/iframe.html?id=tarmac-tds-shimmer--playground&viewMode=story&shortcuts=false`}
          style={{ width: '100%', height: '300px', border: 'none', display: 'block' }}
          title="shimmer interactive example"
          loading="lazy"
          sandbox="allow-scripts allow-same-origin allow-popups allow-forms"
        />
      </div>
      <h2>Anatomy</h2>
      <p>Refer to the Figma design file for detailed anatomy breakdown of the Shimmer component.</p>
      <h2>Variants</h2>
      <p>See the playground below for all available variants of the Shimmer component.</p>
      <h2>States</h2>
