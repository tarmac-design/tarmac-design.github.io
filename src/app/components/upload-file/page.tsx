  ...
  return (
    <>
      <p style={{ marginBottom: '1.5rem' }}>
        <a href="https://tarmac-storybook-dev.pntrzz.com/storybook/sb/index.html?path=/story/tarmac-tds-uploadfile--playground" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', fontWeight: 500, fontSize: '14px' }}>Open in Storybook &#8594;</a>
      </p>
      <h2>Description</h2>
      <p>A file upload component with drag-and-drop support, progress indicators, and file management.</p>
      <h2>Common Use Cases</h2>
      <ul>
        <li>Document uploads</li>
        <li>Image attachments</li>
        <li>Bulk file imports</li>
  ...
  return (
    <>
      ...
      <table><thead><tr><th>Component</th><th>Description</th></tr></thead><tbody>
        <tr><td>Drop Zone</td><td>Drag-and-drop target area</td></tr>
        <tr><td>File List</td><td>Uploaded file entries</td></tr>
        <tr><td>Progress</td><td>Upload progress indicator</td></tr>
        <tr><td>Actions</td><td>Remove or retry controls</td></tr>
      </tbody></table>
      <div style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-outline)', marginTop: '1.5rem', marginBottom: '0.5rem', background: '#fff' }}>
        <iframe src="https://tarmac-storybook-dev.pntrzz.com/storybook/sb/iframe.html?id=tarmac-tds-uploadfile--playground&viewMode=story&shortcuts=false" style={{ width: '100%', height: '300px', border: 'none', display: 'block' }} title="Upload File example" loading="lazy" sandbox="allow-scripts allow-same-origin allow-popups allow-forms" />
      </div>
  ...
  return (
    <RoleToggle>
      {(role) => role === 'designer' ? (
        <>
          <h2>Usage</h2>
          <GuidelineImage title="Upload File usage" slug="upload-file" section="usage" />
          <p>A file upload component with drag-and-drop support, progress indicators, and file management.</p>
          <h2>When to Use</h2>
          <GuidelineImage title="Upload File when to use" slug="upload-file" section="when-to-use" />
          <ul>
        <li>Document uploads</li>
        <li>Image attachments</li>
        <li>Bulk file imports</li>
        <li>Profile photo upload</li>
          ...
          <GuidelineImage title="Upload File when not to use" slug="upload-file" section="when-not-to-use" />
          <ul>
        ...
        <>
          ...
          <h2>Import</h2>
          <pre style={{ background: 'var(--color-surface-dim)', padding: '16px', borderRadius: '8px', fontSize: '13px', overflow: 'auto' }}><code>{`import { UploadFile } from '@tarmac/design-system';`}</code></pre>
          ...
          <h2>Basic Usage</h2>
          <pre style={{ background: 'var(--color-surface-dim)', padding: '16px', borderRadius: '8px', fontSize: '13px', overflow: 'auto' }}><code>{`<UploadFile />`}</code></pre>
        </>
      )}
    </RoleToggle>
  );
...
export default function UploadFilePage() {
  return (
    <PageShell
      title="Upload File"
      description="A file upload component with drag-and-drop support, progress indicators, and file management."
      tabs={[
