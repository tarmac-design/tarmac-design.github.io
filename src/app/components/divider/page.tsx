  ...
  return (
    <RoleToggle>
      {(role) => role === 'designer' ? (
        <>
          <h2>Usage</h2>
          <GuidelineImage title="Divider usage" slug="divider" section="usage" />
          <p>A visual separator used to create clear boundaries between content sections.</p>
          <h2>When to Use</h2>
          <GuidelineImage title="Divider when to use" slug="divider" section="when-to-use" />
          <ul>
        <li>Separating list items</li>
        <li>Dividing form sections</li>
        <li>Breaking content into logical groups</li>
        <li>Creating visual hierarchy</li>
          ...
          <GuidelineImage title="Divider when not to use" slug="divider" section="when-not-to-use" />
          <ul>
