  ...
  return (
    <>
      <p style={{ marginBottom: '1.5rem' }}>
        <a href="https://tarmac-storybook-dev.pntrzz.com/storybook/sb/index.html?path=/story/tarmac-tds-sidenavigation--playground" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', fontWeight: 500, fontSize: '14px' }}>Open in Storybook &#8594;</a>
      </p>
      <h2>Description</h2>
      ...
      <h2>Availability</h2>
      <AvailabilityTable storybookUrl="https://tarmac-storybook-dev.pntrzz.com/storybook/sb/index.html?path=/story/tarmac-tds-sidenavigation--playground" />
    </>
  );
}
  ...
  return (
    <>
      ...
      <table><thead><tr><th>Component</th><th>Description</th></tr></thead><tbody>
        <tr><td>Container</td><td>Vertical navigation wrapper</td></tr>
        <tr><td>Nav Item</td><td>Individual navigation link</td></tr>
        <tr><td>Group</td><td>Collapsible section with children</td></tr>
        <tr><td>Icon</td><td>Leading visual for each item</td></tr>
      </tbody></table>
    ...
    <RoleToggle>
      {(role) => role === 'designer' ? (
        ...
        <>
          ...
          <h2>Basic Usage</h2>
          <pre style={{ background: 'var(--color-surface-dim)', padding: '16px', borderRadius: '8px', fontSize: '13px', overflow: 'auto' }}><code>{`<SidebarNavigation />`}</code></pre>
        </>
      )}
    </RoleToggle>
  );
...
export default function SidebarNavPage() {
  return (
    <PageShell
      ...
      description="A vertical navigation component for multi-level page structure and content hierarchy."
      tabs={[
