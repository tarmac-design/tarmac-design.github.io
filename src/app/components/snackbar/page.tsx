  ...
  return (
    <>
      <p style={{ marginBottom: '1.5rem' }}>
        <a href="https://tarmac-storybook.delhivery.com/storybook/sb/index.html?path=/story/tarmac-tds-snackbar--playground" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', fontWeight: 500, fontSize: '14px' }}>Open in Storybook \u2192</a>
      </p>
      <h2>Description</h2>
      ...
      <h2>Availability</h2>
      <AvailabilityTable storybookUrl="https://tarmac-storybook.delhivery.com/storybook/sb/index.html?path=/story/tarmac-tds-snackbar--playground" />
    </>
  );
}
  ...
  return (
    <>
      ...
      <div style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-outline)', marginBottom: '2rem', background: '#fff' }}>
        <iframe
          src={`https://tarmac-storybook.delhivery.com/storybook/sb/iframe.html?id=tarmac-tds-snackbar--playground&viewMode=story&shortcuts=false`}
          style={{ width: '100%', height: '300px', border: 'none', display: 'block' }}
          title="snackbar interactive example"
          loading="lazy"
          sandbox="allow-scripts allow-same-origin allow-popups allow-forms"
        />
      </div>
      <h2>Anatomy</h2>
      <p>Refer to the Figma design file for detailed anatomy breakdown of the Snackbar component.</p>
      <h2>Variants</h2>
      <p>See the playground below for all available variants of the Snackbar component.</p>
      <h2>States</h2>
