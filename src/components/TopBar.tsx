...
const topNav = [
  ...
  { label: 'Foundations', href: '/foundations', section: 'foundations' },
  ...
  return (
    <>
      ...
      >
        ...
        {onMenuClick && (
          <button onClick={onMenuClick} className="lg:hidden rounded-lg mr-3" style={{ color: heroTextColor, padding: '8px', backgroundColor: 'rgba(255,255,255,0.24)' }} aria-label={sidebarOpen ? 'Close menu' : 'Open menu'}>
            {sidebarOpen ? (
