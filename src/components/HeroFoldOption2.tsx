...
export default function HeroFoldOption2() {
  ...
  const frameTop = Math.round(560 - 420 * rise);
    ...
    <>
      <div ref={spacerRef} style={{ height: `calc(100vh + ${SCROLL_DISTANCE}px)`, position: 'relative' }}>
        ...
        >
          ...
          {/* Hover glow on grid — radial white glow following mouse */}
          {mousePos.x > 0 && (
            <div style={{
              position: 'absolute', inset: 0, pointerEvents: 'none',
              background: `radial-gradient(circle 120px at ${mousePos.x}px ${mousePos.y}px, ${isDark ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.4)'} 0%, transparent 100%)`,
            }} />
          )}
          ...
          <div style={{
            ...
            width: '75%', maxWidth: 1080, zIndex: 2, top: frameTop,
